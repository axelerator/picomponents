...
var $author$project$Main$OnLanding = function (a) {
	return {$: 'OnLanding', a: a};
};
var $author$project$Route$Login = {$: 'Login'};
var $author$project$Main$OnHome = function (a) {
	return {$: 'OnHome', a: a};
};
var $author$project$Main$OnLogin = function (a) {
	return {$: 'OnLogin', a: a};
};
var $author$project$Main$OnNotFound = function (a) {
	return {$: 'OnNotFound', a: a};
};
var $author$project$Main$OnPreferences = function (a) {
	return {$: 'OnPreferences', a: a};
};
var $author$project$Main$OnSignup = function (a) {
	return {$: 'OnSignup', a: a};
};
var $author$project$JSCommand$RemoveRememberMe = {$: 'RemoveRememberMe'};
...
var $author$project$JSCommand$encodePreferences = function (preferences) {
	var colorScheme = function () {
		var _v0 = preferences.colorScheme;
		switch (_v0.$) {
			case 'Light':
				return 'light';
			case 'Dark':
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'colorScheme',
				$elm$json$Json$Encode$string(colorScheme))
			]));
};
var $author$project$JSCommand$encodeRememberMe = function (rememberMe) {
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'sessionId',
				$elm$json$Json$Encode$string(rememberMe.sessionId)),
				_Utils_Tuple2(
				'username',
				$elm$json$Json$Encode$string(rememberMe.username))
			]));
};
var $elm$json$Json$Encode$null = _Json_encodeNull;
var $author$project$JSCommand$encode = function (cmd) {
	switch (cmd.$) {
		case 'StorePreferences':
			var preferences = cmd.a;
			return _Utils_Tuple2(
				'storePreferences',
				$author$project$JSCommand$encodePreferences(preferences));
		case 'StoreRememberMe':
			var rememberMe = cmd.a;
			return _Utils_Tuple2(
				'storeRememberMe',
				$author$project$JSCommand$encodeRememberMe(rememberMe));
		default:
			return _Utils_Tuple2('removeRememberMe', $elm$json$Json$Encode$null);
	}
};
var $author$project$Page$Home$init = _Utils_Tuple0;
var $author$project$Page$Landing$init = _Utils_Tuple0;
var $author$project$Page$Login$WaitingForInput = {$: 'WaitingForInput'};
...
var $author$project$Form$errorToString = function (e) {
	switch (e.$) {
		case 'NotValid':
			return '';
...
var $author$project$Form$errorView = $author$project$Pico$errorView($author$project$Form$errorToString);
...
var $author$project$Form$form = $author$project$FancyForms$Form$form($author$project$Form$errorView);
...
var $author$project$Page$Login$passwordFieldAttrs = F2(
	function (_v0, _v1) {
		return _List_fromArray(
			[
...
var $author$project$FancyForms$Widgets$Checkbox$checkbox = {
	...
	update: F2(
		function (_v2, model) {
			return $author$project$FancyForms$FormState$justChanged(!model);
		}),
...
var $author$project$FancyForms$FormState$withInnerAttributes = F2(
	function (f, widget) {
		var combined = F2(
...
var $author$project$Pico$Form$switch = function (labelText) {
	return A2(
		$author$project$FancyForms$FormState$withInnerAttributes,
		F2(
			function (_v0, _v1) {
				return _List_fromArray(
					[
		...
		A2(
			...
			A2($author$project$Pico$Form$withLabel, labelText, $author$project$FancyForms$Widgets$Checkbox$checkbox)));
};
...
var $author$project$Page$Login$loginForm = A3(
	$author$project$FancyForms$Form$field,
	function ($) {
		return $.rememberMe;
	},
	$author$project$Pico$Form$switch('Remember me'),
	A3(
		$author$project$FancyForms$Form$field,
		function ($) {
			return $.password;
		...
		A2(
			$author$project$FancyForms$FormState$withInnerAttributes,
			$author$project$Page$Login$passwordFieldAttrs,
			A2(
				$author$project$FancyForms$Form$validate,
				_List_fromArray(
					[$author$project$FancyForms$Widgets$Text$notBlank]),
				$author$project$Pico$Form$textInput('password'))),
		A3(
			$author$project$FancyForms$Form$field,
			function ($) {
				return $.username;
			...
			A2(
				...
				_List_fromArray(
					[$author$project$FancyForms$Widgets$Text$notBlank]),
				$author$project$Pico$Form$textInput('username')),
			A3(
...
var $author$project$Page$Login$init = {
	loginFormState: A2(
		$author$project$FancyForms$Form$init,
		$author$project$Page$Login$loginForm,
		{password: '', rememberMe: false, username: ''}),
	submission: $author$project$Page$Login$WaitingForInput
};
var $author$project$Page$NotFound$init = _Utils_Tuple0;
...
var $author$project$Page$Preferences$colorSchemeVariants = _Utils_Tuple2(
	...
	function (labelText, variants) {
		return A2(
			...
			A2(
				$author$project$Pico$Form$withLabel,
				labelText,
				$author$project$FancyForms$Widgets$Dropdown$dropdown(variants)));
	});
var $author$project$Page$Preferences$form = A3(
	$author$project$FancyForms$Form$field,
	function ($) {
		return $.colorScheme;
	},
	A2($author$project$Pico$Form$dropdown, 'Color scheme', $author$project$Page$Preferences$colorSchemeVariants),
	A3(
		$author$project$Form$form,
		$author$project$FancyForms$FormState$alwaysValid,
		'preferences-form',
		function (colorScheme) {
			return {
				...
				view: F2(
					function (formState, _v0) {
						return colorScheme.view(formState);
					})
			};
		}));
var $author$project$Page$Preferences$init = function (session) {
	return A2($author$project$FancyForms$Form$init, $author$project$Page$Preferences$form, session.preferences);
};
var $author$project$Page$Signup$WaitingForInput = {$: 'WaitingForInput'};
var $author$project$Page$Signup$passwordFieldAttrs = F2(
	function (_v0, _v1) {
		return _List_fromArray(
			[
				$elm$html$Html$Attributes$type_('password'),
...
var $author$project$Form$ConfirmationMustMatch = {$: 'ConfirmationMustMatch'};
var $author$project$FancyForms$FormState$CustomError = function (a) {
	return {$: 'CustomError', a: a};
};
var $author$project$Page$Signup$passwordsMustMatch = function (_v0) {
	var password = _v0.password;
	var passwordConfirm = _v0.passwordConfirm;
	return (_Utils_eq(password, passwordConfirm) || (passwordConfirm === '')) ? _List_Nil : _List_fromArray(
		[
			$author$project$FancyForms$FormState$CustomError($author$project$Form$ConfirmationMustMatch)
		]);
};
var $author$project$Page$Signup$viewFormErrors = function (errors) {
	return A2(
		$elm$core$List$map,
		function (e) {
			return A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						$author$project$Form$errorToString(e))
					]));
		},
		errors);
};
var $author$project$Page$Signup$signUpForm = A3(
	$author$project$FancyForms$Form$field,
	function ($) {
	...
	A2(
		$author$project$FancyForms$FormState$withInnerAttributes,
		$author$project$Page$Signup$passwordFieldAttrs,
		A2(
			$author$project$FancyForms$Form$validate,
			_List_fromArray(
				[$author$project$FancyForms$Widgets$Text$notBlank]),
			$author$project$Pico$Form$textInput('password confirmation'))),
	A3(
		$author$project$FancyForms$Form$field,
		function ($) {
			return $.password;
		...
		A3(
			...
			A3(
				$author$project$Form$form,
				$author$project$Page$Signup$passwordsMustMatch,
				'signup-form',
				F3(
									...
									return $elm$core$List$concat(
										_List_fromArray(
											[
												...
												$author$project$Page$Signup$viewFormErrors(errors)
											]));
								})
						};
					})))));
var $author$project$Page$Signup$init = {
	formState: A2(
		$author$project$FancyForms$Form$init,
		$author$project$Page$Signup$signUpForm,
		{password: '', passwordConfirm: '', username: ''}),
	submission: $author$project$Page$Signup$WaitingForInput
};
...
var $author$project$Main$changeRouteTo = F2(
	function (maybeRoute, model) {
		var _v0 = _Utils_Tuple2(maybeRoute, model.session);
		_v0$7:
		while (true) {
			if (_v0.a.$ === 'Nothing') {
				var _v1 = _v0.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							pageModel: $author$project$Main$OnNotFound($author$project$Page$NotFound$init)
						}),
					...
					case 'Landing':
						...
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									pageModel: $author$project$Main$OnLanding($author$project$Page$Landing$init)
								}),
							$elm$core$Platform$Cmd$none);
					case 'Login':
						var _v3 = _v0.a.a;
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									pageModel: $author$project$Main$OnLogin($author$project$Page$Login$init),
					...
					case 'Signup':
						...
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									pageModel: $author$project$Main$OnSignup($author$project$Page$Signup$init)
								}),
							$elm$core$Platform$Cmd$none);
					case 'Logout':
						var _v5 = _v0.a.a;
						return _Utils_Tuple2(
							...
							$author$project$Main$sendToJs(
								$author$project$JSCommand$encode($author$project$JSCommand$RemoveRememberMe)));
					case 'Home':
						if (_v0.b.$ === 'Just') {
							var _v6 = _v0.a.a;
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
										pageModel: $author$project$Main$OnHome($author$project$Page$Home$init)
									}),
								$elm$core$Platform$Cmd$none);
						} else {
							break _v0$7;
						...
						if (_v0.b.$ === 'Just') {
							...
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
										pageModel: $author$project$Main$OnPreferences(
											$author$project$Page$Preferences$init(session))
									}),
								$elm$core$Platform$Cmd$none);
						} else {
							break _v0$7;
...
var $author$project$JSCommand$emptyFlags = {preferences: $elm$core$Maybe$Nothing, rememberMe: $elm$core$Maybe$Nothing};
var $author$project$JSCommand$Flags = F2(
	function (preferences, rememberMe) {
		return {preferences: preferences, rememberMe: rememberMe};
	});
var $author$project$JSCommand$RememberMe = F2(
...
var $author$project$Session$Preferences = function (colorScheme) {
	return {colorScheme: colorScheme};
};
var $author$project$JSCommand$preferencesDecoder = A2(
	$elm$json$Json$Decode$map,
	$author$project$Session$Preferences,
	A2(
		$elm$json$Json$Decode$andThen,
		function (schemeName) {
			switch (schemeName) {
				case 'light':
					return $elm$json$Json$Decode$succeed($author$project$Pico$Theme$Light);
				case 'dark':
					return $elm$json$Json$Decode$succeed($author$project$Pico$Theme$Dark);
				case 'system':
					return $elm$json$Json$Decode$succeed($author$project$Pico$Theme$SystemScheme);
				default:
					return $elm$json$Json$Decode$fail('unknown color scheme');
			}
		},
		A2($elm$json$Json$Decode$field, 'colorScheme', $elm$json$Json$Decode$string)));
var $author$project$JSCommand$flagsDecoder = A3(
	$elm$json$Json$Decode$map2,
	$author$project$JSCommand$Flags,
	$elm$json$Json$Decode$maybe(
		A2($elm$json$Json$Decode$field, 'preferences', $author$project$JSCommand$preferencesDecoder)),
	$elm$json$Json$Decode$maybe(
		A2(
			...
			A3(
				$elm$json$Json$Decode$map2,
				$author$project$JSCommand$RememberMe,
...
var $author$project$Route$Preferences = {$: 'Preferences'};
...
var $author$project$Session$defaultPreferences = {colorScheme: $author$project$Pico$Theme$SystemScheme};
var $author$project$JSCommand$toSession = function (flags) {
	return A2(
		$elm$core$Maybe$map,
		function (_v0) {
			...
			return {
				id: sessionId,
				preferences: A2($elm$core$Maybe$withDefault, $author$project$Session$defaultPreferences, flags.preferences),
				username: username
			};
		},
		flags.rememberMe);
	...
	function (flagsValue, url, key) {
		return A2(
			...
			$author$project$Route$fromUrl(url),
			{
				key: key,
				pageModel: $author$project$Main$OnLanding($author$project$Page$Landing$init),
				session: $author$project$JSCommand$toSession(
					A2(
						$elm$core$Result$withDefault,
						$author$project$JSCommand$emptyFlags,
						A2($elm$json$Json$Decode$decodeValue, $author$project$JSCommand$flagsDecoder, flagsValue)))
			});
	});
var $elm$core$Platform$Sub$batch = _Platform_batch;
var $elm$core$Platform$Sub$none = $elm$core$Platform$Sub$batch(_List_Nil);
var $author$project$Main$ForLanding = function (a) {
	return {$: 'ForLanding', a: a};
};
var $author$project$Main$ForLogin = function (a) {
	return {$: 'ForLogin', a: a};
};
var $author$project$Main$ForSignup = function (a) {
	return {$: 'ForSignup', a: a};
};
var $author$project$JSCommand$StorePreferences = function (a) {
	return {$: 'StorePreferences', a: a};
};
var $elm$browser$Browser$Navigation$load = _Browser_load;
var $author$project$JSCommand$StoreRememberMe = function (a) {
	return {$: 'StoreRememberMe', a: a};
};
var $author$project$Session$init = function (_v0) {
	var sessionId = _v0.sessionId;
	var username = _v0.username;
	return {id: sessionId, preferences: $author$project$Session$defaultPreferences, username: username};
};
var $author$project$Main$login = F3(
	function (model, authResponse, shouldRememberMe) {
		var storeRememberMe = $author$project$Main$sendToJs(
			$author$project$JSCommand$encode(
				$author$project$JSCommand$StoreRememberMe(authResponse)));
		var model_ = _Utils_update(
			model,
			{
				pageModel: $author$project$Main$OnLogin($author$project$Page$Login$init),
				session: $elm$core$Maybe$Just(
					$author$project$Session$init(authResponse))
			});
		var andStoreRememberMe = shouldRememberMe ? function (_v1) {
			var m = _v1.a;
			var c = _v1.b;
			return _Utils_Tuple2(
				m,
		...
		var andSetUrlToHome = function (_v0) {
			var m = _v0.a;
			var c = _v0.b;
			return _Utils_Tuple2(
				m,
		...
		return andSetUrlToHome(
			andStoreRememberMe(
				A2(
					$author$project$Main$changeRouteTo,
					$elm$core$Maybe$Just($author$project$Route$Home),
					model_)));
	});
...
var $author$project$Page$Login$rememberMeSelected = function (model) {
	return A2($author$project$FancyForms$Form$extract, $author$project$Page$Login$loginForm, model.loginFormState).rememberMe;
};
...
var $author$project$Page$Landing$update = F2(
	function (_v0, model) {
		return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
	});
var $author$project$Page$Login$Failed = function (a) {
	return {$: 'Failed', a: a};
};
var $author$project$Page$Login$LoginError = function (a) {
	return {$: 'LoginError', a: a};
};
var $author$project$Page$Login$LoginSuccess = function (a) {
	return {$: 'LoginSuccess', a: a};
};
var $author$project$Page$Login$RequestPending = {$: 'RequestPending'};
...
var $author$project$Api$login = F3(
	function (onSuccess, onFail, _v0) {
		var username = _v0.username;
		var password = _v0.password;
		var msg = _Utils_eq(username, password) ? onSuccess(
			{sessionId: 'sessionId123', username: username}) : onFail('Wrong password');
		return A2(
			$elm$core$Task$perform,
			$elm$core$Basics$identity,
			A2(
			...
			case 'ForForm':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							loginFormState: A3($author$project$FancyForms$Form$update, $author$project$Page$Login$loginForm, formMsg, model.loginFormState),
							submission: $author$project$Page$Login$WaitingForInput
						}),
					$elm$core$Platform$Cmd$none);
			case 'Submit':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{submission: $author$project$Page$Login$RequestPending}),
					A3(
						$author$project$Api$login,
						$author$project$Page$Login$LoginSuccess,
						$author$project$Page$Login$LoginError,
						A2($author$project$FancyForms$Form$extract, $author$project$Page$Login$loginForm, model.loginFormState)));
			case 'LoginSuccess':
				return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
			default:
				var error = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							submission: $author$project$Page$Login$Failed(error)
						}),
					$elm$core$Platform$Cmd$none);
		}
	});
var $author$project$Page$Preferences$update = F2(
	function (msg, model) {
		var formState = A3($author$project$FancyForms$Form$update, $author$project$Page$Preferences$form, msg, model);
		return _Utils_Tuple2(
			formState,
			A2($author$project$FancyForms$Form$extract, $author$project$Page$Preferences$form, formState));
	});
var $author$project$Page$Signup$Failed = function (a) {
	return {$: 'Failed', a: a};
};
var $author$project$Page$Signup$RequestPending = {$: 'RequestPending'};
var $author$project$Page$Signup$SignupError = function (a) {
	return {$: 'SignupError', a: a};
};
var $author$project$Page$Signup$SignupSuccess = function (a) {
	return {$: 'SignupSuccess', a: a};
};
var $author$project$Api$signup = F3(
	function (onSuccess, onFail, _v0) {
		...
		var password = _v0.password;
		var msg = _Utils_eq(username, password) ? onSuccess(
			{sessionId: 'sessionId123', username: username}) : onFail('Username already taken');
		return A2(
			$elm$core$Task$perform,
			$elm$core$Basics$identity,
			A2(
			...
			case 'ForForm':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							formState: A3($author$project$FancyForms$Form$update, $author$project$Page$Signup$signUpForm, formMsg, model.formState)
						}),
					$elm$core$Platform$Cmd$none);
			case 'Submit':
				var _v1 = A2($author$project$FancyForms$Form$extract, $author$project$Page$Signup$signUpForm, model.formState);
				var username = _v1.username;
				var password = _v1.password;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{submission: $author$project$Page$Signup$RequestPending}),
					A3(
						$author$project$Api$signup,
						$author$project$Page$Signup$SignupSuccess,
						$author$project$Page$Signup$SignupError,
			...
			default:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							submission: $author$project$Page$Signup$Failed(e)
						}),
					$elm$core$Platform$Cmd$none);
		}
	});
			...
			switch (_v0.a.$) {
				...
				case 'ForLanding':
					if (_v0.b.$ === 'OnLanding') {
						...
						return A3(
							forMain,
							$author$project$Main$OnLanding,
							$author$project$Main$ForLanding,
							A2($author$project$Page$Landing$update, subMsg, subModel));
					} else {
						break _v0$8;
					}
				case 'ForLogin':
					if (_v0.b.$ === 'OnLogin') {
						if (_v0.a.a.$ === 'LoginSuccess') {
							var authResponse = _v0.a.a.a;
							var subModel = _v0.b.a;
							return A3(
								$author$project$Main$login,
								model,
								authResponse,
								$author$project$Page$Login$rememberMeSelected(subModel));
						} else {
							var subMsg = _v0.a.a;
							var subModel = _v0.b.a;
							return A3(
				...
				case 'ForSignup':
					if (_v0.a.a.$ === 'SignupSuccess') {
						var authResponse = _v0.a.a.a;
						return A3($author$project$Main$login, model, authResponse, false);
					} else {
						if (_v0.b.$ === 'OnSignup') {
							var subMsg = _v0.a.a;
							var subModel = _v0.b.a;
							return A3(
								forMain,
								$author$project$Main$OnSignup,
								$author$project$Main$ForSignup,
				...
				case 'ForPreferences':
					if (_v0.b.$ === 'OnPreferences') {
						var subMsg = _v0.a.a;
						var subModel = _v0.b.a;
						var _v2 = A2($author$project$Page$Preferences$update, subMsg, subModel);
						var model_ = _v2.a;
						var updatedPreferences = _v2.b;
						var _v3 = function () {
							var _v4 = model.session;
							if (_v4.$ === 'Just') {
								var oldSession = _v4.a;
								return _Utils_eq(oldSession.preferences, updatedPreferences) ? _Utils_Tuple2(model.session, $elm$core$Platform$Cmd$none) : _Utils_Tuple2(
									$elm$core$Maybe$Just(
										_Utils_update(
											oldSession,
									...
									$author$project$Main$sendToJs(
										$author$project$JSCommand$encode(
											$author$project$JSCommand$StorePreferences(updatedPreferences))));
							} else {
						...
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									pageModel: $author$project$Main$OnPreferences(model_),
									session: session
								}),
							cmd);
					} else {
...
var $author$project$Main$ForHome = function (a) {
	return {$: 'ForHome', a: a};
};
var $author$project$Main$ForNotFound = function (a) {
	return {$: 'ForNotFound', a: a};
};
var $author$project$Main$ForPreferences = function (a) {
	return {$: 'ForPreferences', a: a};
};
...
var $author$project$Page$Home$homeMd = A2($elm_explorations$markdown$Markdown$toHtml, _List_Nil, '\n# Home\n\nThis is the home page for logged in users.\n');
var $author$project$Pico$Centered = {$: 'Centered'};
var $phosphor_icons$phosphor_elm$Phosphor$Duotone = {$: 'Duotone'};
...
var $author$project$Pico$mkLi = function (cell) {
	return A2($elm$html$Html$li, _List_Nil, cell);
};
var $elm$html$Html$summary = _VirtualDom_node('summary');
var $elm$html$Html$ul = _VirtualDom_node('ul');
var $author$project$Pico$dropdown = F2(
	function (summaryContent, dropdownRows) {
		return A2(
			...
			_List_fromArray(
				[
					A2($elm$html$Html$summary, _List_Nil, summaryContent),
					A2(
					$elm$html$Html$ul,
					_List_Nil,
					A2($elm$core$List$map, $author$project$Pico$mkLi, dropdownRows))
				]));
	});
...
var $phosphor_icons$phosphor_elm$Phosphor$house = function (weight) {
	var elements = function () {
		switch (weight.$) {
			case 'Bold':
				return _List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$svg$Svg$Attributes$d('M222.14,105.85l-80-80a20,20,0,0,0-28.28,0l-80,80A19.86,19.86,0,0,0,28,120v96a12,12,0,0,0,12,12h64a12,12,0,0,0,12-12V164h24v52a12,12,0,0,0,12,12h64a12,12,0,0,0,12-12V120A19.86,19.86,0,0,0,222.14,105.85ZM204,204H164V152a12,12,0,0,0-12-12H104a12,12,0,0,0-12,12v52H52V121.65l76-76,76,76Z')
							]),
						_List_Nil)
					]);
			case 'Duotone':
				return _List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$svg$Svg$Attributes$d('M216,120v96H152V152H104v64H40V120a8,8,0,0,1,2.34-5.66l80-80a8,8,0,0,1,11.32,0l80,80A8,8,0,0,1,216,120Z'),
								$elm$svg$Svg$Attributes$opacity('0.2')
							]),
						_List_Nil),
						A2(
						...
						_List_fromArray(
							[
								$elm$svg$Svg$Attributes$d('M219.31,108.68l-80-80a16,16,0,0,0-22.62,0l-80,80A15.87,15.87,0,0,0,32,120v96a8,8,0,0,0,8,8h64a8,8,0,0,0,8-8V160h32v56a8,8,0,0,0,8,8h64a8,8,0,0,0,8-8V120A15.87,15.87,0,0,0,219.31,108.68ZM208,208H160V152a8,8,0,0,0-8-8H104a8,8,0,0,0-8,8v56H48V120l80-80,80,80Z')
							]),
						_List_Nil)
					]);
			case 'Fill':
				return _List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$svg$Svg$Attributes$d('M224,120v96a8,8,0,0,1-8,8H160a8,8,0,0,1-8-8V164a4,4,0,0,0-4-4H108a4,4,0,0,0-4,4v52a8,8,0,0,1-8,8H40a8,8,0,0,1-8-8V120a16,16,0,0,1,4.69-11.31l80-80a16,16,0,0,1,22.62,0l80,80A16,16,0,0,1,224,120Z')
							]),
						_List_Nil)
					]);
			case 'Light':
			...
			default:
				return _List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$svg$Svg$Attributes$d('M216.49,111.51l-80-80a12,12,0,0,0-17,0l-80,80A12,12,0,0,0,36,120v96a4,4,0,0,0,4,4h64a4,4,0,0,0,4-4V156h40v60a4,4,0,0,0,4,4h64a4,4,0,0,0,4-4V120A12,12,0,0,0,216.49,111.51ZM212,212H156V152a4,4,0,0,0-4-4H104a4,4,0,0,0-4,4v60H44V120a4,4,0,0,1,1.17-2.83l80-80a4,4,0,0,1,5.66,0l80,80A4,4,0,0,1,212,120Z')
							]),
						_List_Nil)
					]);
		}
...
var $phosphor_icons$phosphor_elm$Phosphor$signIn = function (weight) {
	var elements = function () {
		switch (weight.$) {
			case 'Bold':
				return _List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$svg$Svg$Attributes$d('M144.49,136.49l-40,40a12,12,0,0,1-17-17L107,140H24a12,12,0,0,1,0-24h83L87.51,96.49a12,12,0,0,1,17-17l40,40A12,12,0,0,1,144.49,136.49ZM200,28H136a12,12,0,0,0,0,24h52V204H136a12,12,0,0,0,0,24h64a12,12,0,0,0,12-12V40A12,12,0,0,0,200,28Z')
							]),
						_List_Nil)
					]);
			case 'Duotone':
				return _List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$svg$Svg$Attributes$d('M200,40V216H40a16,16,0,0,1-16-16V56A16,16,0,0,1,40,40Z'),
								$elm$svg$Svg$Attributes$opacity('0.2')
							]),
						_List_Nil),
						A2(
						...
						_List_fromArray(
							[
								$elm$svg$Svg$Attributes$d('M141.66,133.66l-40,40a8,8,0,0,1-11.32-11.32L116.69,136H24a8,8,0,0,1,0-16h92.69L90.34,93.66a8,8,0,0,1,11.32-11.32l40,40A8,8,0,0,1,141.66,133.66ZM200,32H136a8,8,0,0,0,0,16h56V208H136a8,8,0,0,0,0,16h64a8,8,0,0,0,8-8V40A8,8,0,0,0,200,32Z')
							]),
						_List_Nil)
					]);
			case 'Fill':
				return _List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$svg$Svg$Attributes$d('M141.66,133.66l-40,40A8,8,0,0,1,88,168V136H24a8,8,0,0,1,0-16H88V88a8,8,0,0,1,13.66-5.66l40,40A8,8,0,0,1,141.66,133.66ZM200,32H136a8,8,0,0,0,0,16h56V208H136a8,8,0,0,0,0,16h64a8,8,0,0,0,8-8V40A8,8,0,0,0,200,32Z')
							]),
						_List_Nil)
					]);
			case 'Light':
				return _List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$svg$Svg$Attributes$d('M140.24,132.24l-40,40a6,6,0,0,1-8.48-8.48L121.51,134H24a6,6,0,0,1,0-12h97.51L91.76,92.24a6,6,0,0,1,8.48-8.48l40,40A6,6,0,0,1,140.24,132.24ZM200,34H136a6,6,0,0,0,0,12h58V210H136a6,6,0,0,0,0,12h64a6,6,0,0,0,6-6V40A6,6,0,0,0,200,34Z')
							]),
						_List_Nil)
					]);
			case 'Regular':
			...
			default:
				return _List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$svg$Svg$Attributes$d('M138.83,130.83l-40,40a4,4,0,0,1-5.66-5.66L126.34,132H24a4,4,0,0,1,0-8H126.34L93.17,90.83a4,4,0,0,1,5.66-5.66l40,40A4,4,0,0,1,138.83,130.83ZM200,36H136a4,4,0,0,0,0,8h60V212H136a4,4,0,0,0,0,8h64a4,4,0,0,0,4-4V40A4,4,0,0,0,200,36Z')
							]),
						_List_Nil)
					]);
		}
...
var $phosphor_icons$phosphor_elm$Phosphor$signOut = function (weight) {
	var elements = function () {
		switch (weight.$) {
			case 'Bold':
				return _List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$svg$Svg$Attributes$d('M124,216a12,12,0,0,1-12,12H48a12,12,0,0,1-12-12V40A12,12,0,0,1,48,28h64a12,12,0,0,1,0,24H60V204h52A12,12,0,0,1,124,216Zm108.49-96.49-40-40a12,12,0,0,0-17,17L195,116H112a12,12,0,0,0,0,24h83l-19.52,19.51a12,12,0,0,0,17,17l40-40A12,12,0,0,0,232.49,119.51Z')
							]),
						_List_Nil)
					]);
			case 'Duotone':
				return _List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$svg$Svg$Attributes$d('M224,56V200a16,16,0,0,1-16,16H48V40H208A16,16,0,0,1,224,56Z'),
								$elm$svg$Svg$Attributes$opacity('0.2')
							]),
						_List_Nil),
						A2(
						...
						_List_fromArray(
							[
								$elm$svg$Svg$Attributes$d('M120,216a8,8,0,0,1-8,8H48a8,8,0,0,1-8-8V40a8,8,0,0,1,8-8h64a8,8,0,0,1,0,16H56V208h56A8,8,0,0,1,120,216Zm109.66-93.66-40-40a8,8,0,0,0-11.32,11.32L204.69,120H112a8,8,0,0,0,0,16h92.69l-26.35,26.34a8,8,0,0,0,11.32,11.32l40-40A8,8,0,0,0,229.66,122.34Z')
							]),
						_List_Nil)
					]);
			case 'Fill':
				return _List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$svg$Svg$Attributes$d('M120,216a8,8,0,0,1-8,8H48a8,8,0,0,1-8-8V40a8,8,0,0,1,8-8h64a8,8,0,0,1,0,16H56V208h56A8,8,0,0,1,120,216Zm109.66-93.66-40-40A8,8,0,0,0,176,88v32H112a8,8,0,0,0,0,16h64v32a8,8,0,0,0,13.66,5.66l40-40A8,8,0,0,0,229.66,122.34Z')
							]),
						_List_Nil)
					]);
			case 'Light':
				return _List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$svg$Svg$Attributes$d('M118,216a6,6,0,0,1-6,6H48a6,6,0,0,1-6-6V40a6,6,0,0,1,6-6h64a6,6,0,0,1,0,12H54V210h58A6,6,0,0,1,118,216Zm110.24-92.24-40-40a6,6,0,0,0-8.48,8.48L209.51,122H112a6,6,0,0,0,0,12h97.51l-29.75,29.76a6,6,0,1,0,8.48,8.48l40-40A6,6,0,0,0,228.24,123.76Z')
							]),
						_List_Nil)
					]);
			case 'Regular':
			...
			default:
				return _List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$svg$Svg$Attributes$d('M116,216a4,4,0,0,1-4,4H48a4,4,0,0,1-4-4V40a4,4,0,0,1,4-4h64a4,4,0,0,1,0,8H52V212h60A4,4,0,0,1,116,216Zm110.83-90.83-40-40a4,4,0,0,0-5.66,5.66L214.34,124H112a4,4,0,0,0,0,8H214.34l-33.17,33.17a4,4,0,0,0,5.66,5.66l40-40A4,4,0,0,0,226.83,125.17Z')
							]),
						_List_Nil)
					]);
		}
			...
			case 'Bold':
				return _List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$svg$Svg$Attributes$d('M234.38,210a123.36,123.36,0,0,0-60.78-53.23,76,76,0,1,0-91.2,0A123.36,123.36,0,0,0,21.62,210a12,12,0,1,0,20.77,12c18.12-31.32,50.12-50,85.61-50s67.49,18.69,85.61,50a12,12,0,0,0,20.77-12ZM76,96a52,52,0,1,1,52,52A52.06,52.06,0,0,1,76,96Z')
							]),
						_List_Nil)
					]);
			case 'Duotone':
				return _List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$svg$Svg$Attributes$d('M192,96a64,64,0,1,1-64-64A64,64,0,0,1,192,96Z'),
								$elm$svg$Svg$Attributes$opacity('0.2')
							]),
						_List_Nil),
						A2(
						...
						_List_fromArray(
							[
								$elm$svg$Svg$Attributes$d('M230.92,212c-15.23-26.33-38.7-45.21-66.09-54.16a72,72,0,1,0-73.66,0C63.78,166.78,40.31,185.66,25.08,212a8,8,0,1,0,13.85,8c18.84-32.56,52.14-52,89.07-52s70.23,19.44,89.07,52a8,8,0,1,0,13.85-8ZM72,96a56,56,0,1,1,56,56A56.06,56.06,0,0,1,72,96Z')
							]),
						_List_Nil)
					]);
			case 'Fill':
				return _List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$svg$Svg$Attributes$d('M230.93,220a8,8,0,0,1-6.93,4H32a8,8,0,0,1-6.92-12c15.23-26.33,38.7-45.21,66.09-54.16a72,72,0,1,1,73.66,0c27.39,8.95,50.86,27.83,66.09,54.16A8,8,0,0,1,230.93,220Z')
							]),
						_List_Nil)
					]);
			case 'Light':
				return _List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$svg$Svg$Attributes$d('M229.19,213c-15.81-27.32-40.63-46.49-69.47-54.62a70,70,0,1,0-63.44,0C67.44,166.5,42.62,185.67,26.81,213a6,6,0,1,0,10.38,6C56.4,185.81,90.34,166,128,166s71.6,19.81,90.81,53a6,6,0,1,0,10.38-6ZM70,96a58,58,0,1,1,58,58A58.07,58.07,0,0,1,70,96Z')
							]),
						_List_Nil)
					]);
			case 'Regular':
			...
			default:
				return _List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$svg$Svg$Attributes$d('M227.46,214c-16.52-28.56-43-48.06-73.68-55.09a68,68,0,1,0-51.56,0c-30.64,7-57.16,26.53-73.68,55.09a4,4,0,0,0,6.92,4C55,184.19,89.62,164,128,164s73,20.19,92.54,54a4,4,0,0,0,3.46,2,3.93,3.93,0,0,0,2-.54A4,4,0,0,0,227.46,214ZM68,96a60,60,0,1,1,60,60A60.07,60.07,0,0,1,68,96Z')
							]),
						_List_Nil)
					]);
		}
...
var $author$project$Layout$loginItems = function (mbSession) {
	if (mbSession.$ === 'Nothing') {
		return _List_fromArray(
			[
				_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$author$project$Route$href($author$project$Route$Signup)
						]),
					_List_fromArray(
						[
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_Nil,
							$phosphor_icons$phosphor_elm$Phosphor$signIn($phosphor_icons$phosphor_elm$Phosphor$Regular))
						]))
				])
			]);
	} else {
		var username = mbSession.a.username;
		return _List_fromArray(
			[
				_List_fromArray(
				[
					A2(
					$author$project$Pico$dropdown,
					_List_fromArray(
						[
							A2(
							$phosphor_icons$phosphor_elm$Phosphor$toHtml,
							_List_Nil,
							$phosphor_icons$phosphor_elm$Phosphor$user($phosphor_icons$phosphor_elm$Phosphor$Regular)),
							$elm$html$Html$text(' '),
					...
					_List_fromArray(
						[
							...
							[
								...
								_List_fromArray(
									[
										...
										$phosphor_icons$phosphor_elm$Phosphor$toHtml,
										_List_Nil,
										$phosphor_icons$phosphor_elm$Phosphor$house($phosphor_icons$phosphor_elm$Phosphor$Regular)),
							...
							[
								...
								_List_fromArray(
									[
										$author$project$Route$href($author$project$Route$Preferences)
									]),
								_List_fromArray(
									[
										A2(
							...
							[
								...
								_List_fromArray(
									[
										...
										$phosphor_icons$phosphor_elm$Phosphor$toHtml,
										_List_Nil,
										$phosphor_icons$phosphor_elm$Phosphor$signOut($phosphor_icons$phosphor_elm$Phosphor$Regular)),
...
var $author$project$Session$preferredColorScheme = function (mbSession) {
	if (mbSession.$ === 'Nothing') {
		return $author$project$Pico$Theme$SystemScheme;
	} else {
		var preferences = mbSession.a.preferences;
		return preferences.colorScheme;
	}
};
var $phosphor_icons$phosphor_elm$Phosphor$scribbleLoop = function (weight) {
	var elements = function () {
		switch (weight.$) {
			case 'Bold':
				return _List_fromArray(
			...
			case 'Duotone':
				return _List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$svg$Svg$Attributes$d('M108.6,208c-64,0-64-96,32-96a134.44,134.44,0,0,1,44.73,7.83h0C187,162.36,159.88,208,108.6,208Z'),
								$elm$svg$Svg$Attributes$opacity('0.2')
							]),
						_List_Nil),
						A2(
						...
						_List_fromArray(
							[
								$elm$svg$Svg$Attributes$d('M253.93,154.63c-1.32-1.46-24.09-26.22-61-40.56-1.72-18.42-8.46-35.17-19.41-47.92C158.87,49,137.58,40,112,40,60.48,40,26.89,86.18,25.49,88.15a8,8,0,0,0,13,9.31C38.8,97.05,68.81,56,112,56c20.77,0,37.86,7.11,49.41,20.57,7.42,8.64,12.44,19.69,14.67,32A140.87,140.87,0,0,0,140.6,104c-26.06,0-47.93,6.81-63.26,19.69C63.78,135.09,56,151,56,167.25A47.59,47.59,0,0,0,69.87,201.3c9.66,9.62,23.06,14.7,38.73,14.7,51.81,0,81.18-42.13,84.49-84.42a161.43,161.43,0,0,1,49,33.79,8,8,0,1,0,11.86-10.74Zm-94.46,21.64C150.64,187.09,134.66,200,108.6,200,83.32,200,72,183.55,72,167.25,72,144.49,93.47,120,140.6,120a124.34,124.34,0,0,1,36.78,5.68C176.93,144.44,170.46,162.78,159.47,176.27Z')
							]),
						_List_Nil)
					]);
			case 'Fill':
		...
		return {
			body: _List_fromArray(
				[
					...
					$author$project$Pico$Centered,
					$author$project$Session$preferredColorScheme(session),
					_List_Nil,
					A2(
						$elm$core$List$cons,
										...
										[
											...
											_List_fromArray(
												[
													...
													_List_fromArray(
														[
															$author$project$Route$href($author$project$Route$Landing)
														]),
													_List_fromArray(
														[
															A2(
															$phosphor_icons$phosphor_elm$Phosphor$toHtml,
															_List_Nil,
															$phosphor_icons$phosphor_elm$Phosphor$scribbleLoop($phosphor_icons$phosphor_elm$Phosphor$Duotone)),
															$elm$html$Html$text(' Logo')
														]))
												]))
										])
									]),
									$author$project$Layout$loginItems(session)
								])),
						content))
				]),
			title: 'Picomponents'
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_Nil,
					_List_fromArray(
						[$author$project$Page$Home$homeMd]))
				]));
	});
var $author$project$Page$Landing$mdOptions = {
	defaultHighlighting: $elm$core$Maybe$Nothing,
	githubFlavored: $elm$core$Maybe$Just(
...
var $author$project$Page$Login$loginMd = A2($elm_explorations$markdown$Markdown$toHtml, _List_Nil, '\n# Login\n\nThe login uses a mock API that will succeed if the username and password are the same\nand return an error otherwise.\n');
...
var $author$project$Page$Login$view = function (_v0) {
	var loginFormState = _v0.loginFormState;
	var submission = _v0.submission;
	var submitButtonAttrs = function () {
		var _v3 = _Utils_Tuple2(
			submission,
			A2($author$project$FancyForms$Form$isValid, $author$project$Page$Login$loginForm, loginFormState));
		switch (_v3.a.$) {
			case 'WaitingForInput':
				if (_v3.b) {
					...
					return _List_fromArray(
						[
							$elm$html$Html$Events$onClick($author$project$Page$Login$Submit),
	...
	var _v1 = function () {
		if (submission.$ === 'Failed') {
			...
			return _Utils_Tuple2(
				...
				_List_fromArray(
					[
						A2($author$project$Pico$aria, 'invalid', 'true')
					]));
		} else {
			return _Utils_Tuple2(
				$elm$html$Html$text(''),
	...
	var errorsView = _v1.a;
	var invalidAttr = _v1.b;
	return A2(
		$author$project$Layout$layout,
		$elm$core$Maybe$Nothing,
		_List_fromArray(
				...
				_List_fromArray(
					[
						...
						[
							...
							_List_Nil,
							_List_fromArray(
								[$author$project$Page$Login$loginMd]))
						]),
						_List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									...
									invalidAttr,
									A3($author$project$FancyForms$Form$render, $author$project$Page$Login$ForForm, $author$project$Page$Login$loginForm, loginFormState)),
									errorsView,
									A2(
					...
					_List_fromArray(
						[
							...
							[
								...
								_List_Nil,
								_List_fromArray(
									[$author$project$Page$Preferences$preferencesMd]))
							]),
							A3($author$project$FancyForms$Form$render, $elm$core$Basics$identity, $author$project$Page$Preferences$form, model)
						]))
				]));
	});
var $author$project$Page$Signup$signupMd = A2($elm_explorations$markdown$Markdown$toHtml, _List_Nil, '\n# Signup\n\nThe signup page uses a mock API call.let\nIf you submit the form with the username `taken` you will get an error `Username already taken`.\n');
var $author$project$Page$Signup$ForForm = function (a) {
	return {$: 'ForForm', a: a};
};
var $author$project$Page$Signup$Submit = {$: 'Submit'};
var $author$project$Page$Signup$viewForm = function (_v0) {
	var formState = _v0.formState;
	var submission = _v0.submission;
	var submitButtonAttrs = function () {
		var _v3 = _Utils_Tuple2(
			submission,
			A2($author$project$FancyForms$Form$isValid, $author$project$Page$Signup$signUpForm, formState));
		switch (_v3.a.$) {
			case 'WaitingForInput':
				if (_v3.b) {
					var _v4 = _v3.a;
	...
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Events$onSubmit($author$project$Page$Signup$Submit)
			]),
		_List_fromArray(
			[
				A2(
				$elm$html$Html$fieldset,
				invalidAttr,
				A3($author$project$FancyForms$Form$render, $author$project$Page$Signup$ForForm, $author$project$Page$Signup$signUpForm, formState)),
				errorsView,
				A2(
				$author$project$Pico$primaryButton,
				submitButtonAttrs,
				...
				_List_fromArray(
					[
						...
						[
							...
							_List_Nil,
							_List_fromArray(
								[$author$project$Page$Signup$signupMd]))
						]),
						_List_fromArray(
						[
							$author$project$Page$Signup$viewForm(model)
						])
					]))
			]));
};
	...
	switch (_v0.$) {
		case 'OnLanding':
			...
			return A2(
				...
				$author$project$Main$ForLanding,
				A2($author$project$Page$Landing$view, session, m));
		case 'OnLogin':
			var m = _v0.a;
			return A2(
				$author$project$Main$documentMap,
		...
		case 'OnSignup':
			...
			return A2(
				$author$project$Main$documentMap,
				$author$project$Main$ForSignup,
				$author$project$Page$Signup$view(m));
		case 'OnNotFound':
			var m = _v0.a;
			return A2(
				$author$project$Main$documentMap,
				$author$project$Main$ForNotFound,
				$author$project$Page$NotFound$view(m));
		case 'OnHome':
			var m = _v0.a;
			return A2(
				$author$project$Main$documentMap,
				$author$project$Main$ForHome,
				A2($author$project$Page$Home$view, session, m));
		default:
			var m = _v0.a;
			return A2(
				$author$project$Main$documentMap,
				$author$project$Main$ForPreferences,
				A2($author$project$Page$Preferences$view, session, m));
	}
};
